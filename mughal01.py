...
def banner():
	...
	ban='''
•   AUTHOR  : MUGHAL ZADA   •
         __  ___  ____  ____  ___    _   ______ 
        /  |/  / / __ )/ __ \/   |  / | / / __ \
       / /|_/ / / __  / /_/ / /| | /  |/ / / / /
      / /  / / / /_/ / _, _/ ___ |/ /|  / /_/ / 
     /_/  /_(_)_____/_/ |_/_/  |_/_/ |_/_____/  
•                                               •
•   GITHUB : https:// github.com/mughalzada946   •'''
...
def ceker(idf,pw):
	global cp
	ua = 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.103 Safari/537.36 FBMF/HUAWEI;FBBD/HUAWEI;FBPN/com.facebook.services;FBDV/EVR-L29;FBSV/10;FBLR/0;FBBK/1;FBCA/arm64-v8a:;]'
